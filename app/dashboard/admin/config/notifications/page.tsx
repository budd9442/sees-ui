...
export default function NotificationsPage() {
  ...
  const { notificationTemplates, addNotificationTemplate, updateNotificationTemplate, deleteNotificationTemplate } = useAppStore();
  ...
  const handleAddEditTemplate = () => {
    ...
    if (editingTemplate) {
      updateNotificationTemplate(editingTemplate.id, { ...templateData, updatedAt: new Date().toISOString() });
  ...
  const handlePreviewTemplate = (template: NotificationTemplate) => {
    // In a real application, this would render a preview of the notification
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage email and system notification templates for various events.
          </p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Define the content and triggers for your notification template.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => setTemplateData({ ...templateData, category: value as NotificationTemplate['category'] })}
                >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="template-placeholders" className="text-right">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['{{studentName}}', '{{moduleName}}', '{{grade}}', '{{gpa}}', '{{pathway}}', '{{deadline}}'].map((placeholder) => (
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          const newPlaceholders = templateData.placeholders.includes(placeholder)
                            ? templateData.placeholders.filter(p => p !== placeholder)
                            : [...templateData.placeholders, placeholder];
                          setTemplateData({ ...templateData, placeholders: newPlaceholders });
                        }}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage and configure notification templates for different events.
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {notificationTemplates.filter(t => t.category === 'system_alert').length}
            </div>
