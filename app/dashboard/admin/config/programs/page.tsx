    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Configure degree programs, pathways, and specializations
          </p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => exportPrograms('csv')}>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{degreePrograms.length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {degreePrograms.reduce((sum, program) => sum + program.pathways.length, 0)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {degreePrograms.reduce((sum, program) => 
                sum + Object.values(program.specializations).reduce((specSum, specs) => specSum + specs.length, 0), 0
              )}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {degreePrograms.reduce((sum, program) => 
                sum + Object.values(program.capacityLimits).reduce((capSum, cap) => capSum + cap, 0), 0
              )}
            </div>
      ...
      <Tabs defaultValue="programs" className="space-y-4">
        ...
        <TabsContent value="programs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage degree programs and their configurations
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {degreePrograms.map((program) => (
                    <TableRow key={program.id}>
                      ...
                      <TableCell>
                        <div className="font-medium">{program.duration} years</div>
                      </TableCell>
                      <TableCell>
                        <div className="font-medium">{program.totalCredits}</div>
                      </TableCell>
                      <TableCell>
                        <div className="text-sm">{program.pathways.length} pathways</div>
                      </TableCell>
                      <TableCell>
        ...
        <TabsContent value="pathways" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Pathway Configuration</CardTitle>
              <CardDescription>
                Configure pathways for each degree program
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {degreePrograms.map((program) => (
                  <div key={program.id} className="p-4 rounded-lg border">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge variant="outline">{program.pathways.length} pathways</Badge>
                    </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-sm text-muted-foreground">
                                Capacity: {program.capacityLimits[pathway as keyof typeof program.capacityLimits] || 'N/A'}
                              </span>
        ...
        <TabsContent value="specializations" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Specialization Configuration</CardTitle>
              <CardDescription>
                Configure specializations for each pathway
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {degreePrograms.map((program) => (
                  <div key={program.id} className="p-4 rounded-lg border">
                    ...
                    <div className="space-y-3">
                      {Object.entries(program.specializations).map(([pathway, specializations]) => (
                        <div key={pathway} className="p-3 rounded bg-muted">
                          <h5 className="font-medium mb-2">{pathway}</h5>
                          <div className="grid gap-2 md:grid-cols-2">
                            {specializations.map((specialization: string) => (
                              <div key={specialization} className="flex items-center justify-between p-2 rounded bg-background">
        ...
        <TabsContent value="modules" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Module Mappings</CardTitle>
              <CardDescription>
                Configure module mappings for each degree program
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {degreePrograms.map((program) => (
                  <div key={program.id} className="p-4 rounded-lg border">
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="font-semibold">{program.name}</h4>
                      <Badge variant="outline">{program.moduleMappings.length} modules</Badge>
                    </div>
                    <div className="grid gap-2 md:grid-cols-3">
                      {program.moduleMappings.map((module) => (
                        <div key={module} className="p-2 rounded bg-muted">
                          <div className="flex items-center justify-between">
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new degree program with pathways and specializations
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewProgram({ ...newProgram, totalCredits: parseInt(e.target.value) })}
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Input
                  placeholder="Add pathway (press Enter to add)"
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
                      const pathway = e.currentTarget.value.trim();
                      if (pathway && !newProgram.pathways.includes(pathway)) {
                        setNewProgram({
                          ...newProgram,
                          pathways: [...newProgram.pathways, pathway],
                        });
                    ...
                    <Badge key={index} variant="secondary" className="flex items-center gap-1">
                      ...
                      <button
                        onClick={() => setNewProgram({
                          ...newProgram,
                          pathways: newProgram.pathways.filter((_, i) => i !== index),
                        })}
                      >
                        <X className="h-3 w-3" />
                      </button>
            ...
            <Alert>
              ...
              <AlertDescription>
                You can configure specializations and capacity limits after creating the program.
              </AlertDescription>
            </Alert>
          </div>
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Update degree program configuration
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSelectedProgram({ ...selectedProgram, totalCredits: parseInt(e.target.value) })}
                  />
                </div>
                <div className="space-y-2">
