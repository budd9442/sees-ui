    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Comprehensive view of {student.name}'s academic progress
          </p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" onClick={exportStudentRecord}>
            <Download className="mr-2 h-4 w-4" />
            Export Record
          </Button>
          <Button onClick={() => setShowInterventionDialog(true)}>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{academicClass}</div>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <div className="font-medium">Dr. Smith (You)</div>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          {isAtRisk && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                This student's academic performance indicates they may need additional support. 
                Consider creating an intervention or scheduling a meeting to discuss their progress.
              </AlertDescription>
            </Alert>
          )}
        </TabsContent>
        ...
        <TabsContent value="grades" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete grade history for {student.name}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
        ...
        <TabsContent value="attendance" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Attendance across different modules
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
      ...
      <Dialog open={showInterventionDialog} onOpenChange={setShowInterventionDialog}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>Create Academic Intervention</DialogTitle>
            <DialogDescription>
              Create a new intervention for {student.name}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setInterventionData({ ...interventionData, type: value as any })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={interventionData.severity}
                  onValueChange={(value) => setInterventionData({ ...interventionData, severity: value as any })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setInterventionData({ ...interventionData, title: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Button variant="outline" onClick={handleAddSuggestion}>
            ...
            <div className="space-y-2">
              <Label htmlFor="advisorNote">Advisor Notes</Label>
              <Textarea
                id="advisorNote"
                value={advisorNote}
                onChange={(e) => setAdvisorNote(e.target.value)}
                placeholder="Internal notes for advisor use"
                rows={3}
              />
            </div>
          </div>
