...
export default function RankingsPage() {
  ...
  const calculateRankings = () => {
    const studentRankings: RankingEntry[] = students.map(student => {
      ...
      const totalCreditsEarned = studentGrades.filter(g => g.grade >= 50).reduce((sum, g) => sum + g.credits, 0);
      const totalCreditsAttempted = studentGrades.reduce((sum, g) => sum + g.credits, 0);
      ...
      switch (selectedCategory) {
        case 'overall':
          weightedScore = gpa * 0.6 + (passRate / 100) * 0.4;
          break;
        case 'gpa':
          weightedScore = gpa;
          break;
        case 'credits':
          weightedScore = totalCreditsEarned;
          break;
        case 'pass-rate':
          weightedScore = passRate;
          break;
        default:
          weightedScore = gpa;
      }
