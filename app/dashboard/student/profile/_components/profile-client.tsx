...
import { updateStudentProfile } from '@/lib/actions/student-subactions';
...
export default function ProfileClient({ initialProfile }: { initialProfile: any }) {
    ...
    const academicInfo = initialProfile.academicInfo;
                            ...
                            <div className="grid gap-6">
                                <div className="grid gap-4 md:grid-cols-3">
                                    <Card>
                                        ...
                                        <CardContent>
                                            <div className="text-2xl font-bold">{academicInfo?.currentGPA?.toFixed(2) || '0.00'}</div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <p className="font-medium">
                                                {academicInfo?.enrollmentDate ? new Date(academicInfo.enrollmentDate).toLocaleDateString() : '-'}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Calendar className="h-4 w-4 text-muted-foreground" />
                                            <p className="font-medium">
                                                {academicInfo?.expectedGraduation ? new Date(academicInfo.expectedGraduation).toLocaleDateString() : '-'}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="space-y-1">
